      ...
      builder: (context, provider, child) {
        return Container(
          ...
          child: Material(
            ...
            child: InkWell(
              onTap: provider.isAddQcCheckLoading
                  ? null
                  : () async {
                      if (_formKey.currentState!.saveAndValidate()) {
                        ...
                        final selectedProduct = provider.products.firstWhere(
                          (product) =>
                        ...
                        try {
                          await provider.createQcCheck(qcCheckData);
                          if (provider.error == null) {
                            context.showSuccessSnackbar(
                              'QC Check added successfully',
                            );
                            context.go(RouteNames.qcCheck);
                          } else {
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      if (provider.isAddQcCheckLoading)
                        SizedBox(
                          width: 20.sp,
                          height: 20.sp,
