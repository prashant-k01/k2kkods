...
//       final provider = Provider.of<IronWorkorderProvider>(context, listen: false);
//       provider.loadWorkOrderById(widget.workOrderId);
//     });
//   }
...
//                                 ? workOrder.products[0].deliveryDate
//                                 : "N/A",
//                           ),
//                           WorkOrderField(
//                             label: "Status",
...
//                           label: "Sample Shape",
//                           value: workOrder.products.isNotEmpty
//                               ? workOrder.products[0].shapeId?.description
//                               : 'N/A',
//                         ),
//                       ],
//                     ),
...
//                       headerGradient: AppTheme.cardGradientYellow,
//                       title: 'Job Orders',
//                       subtitle: '${workOrder.jobOrders.length} Job Orders',
//                       icon: IconContainer(
...
//                                 value: jo.product,
//                               ),
//                               WorkOrderField(label: "UOM", value: jo.uom),
//                               WorkOrderField(
//                                 label: "PO Qty",
//                                 value: jo.poQuantity,
//                               ),
//                               WorkOrderField(
//                                 label: "Planned",
//                                 value: jo.plannedQuantity,
//                               ),
//                               WorkOrderField(
//                                 label: "Achieved",
//                                 value: jo.achievedQuantity,
//                               ),
//                               WorkOrderField(
//                                 label: "Rejected",
//                                 value: jo.rejectedQuantity,
//                               ),
//                               WorkOrderField(
//                                 label: "Recycled",
//                                 value: jo.recycledQuantity,
//                               ),
//                             ];
//                           },
//                           itemName: 'Job Order',
